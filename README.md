...
## 2. Meshblock Boundary Data

Meshblock geometry polygons used for spatial sampling.
...
Population statistics used for weighting meshblocks.

Source:

```text
https://datafinder.stats.govt.nz/layer/119478-2023-census-population-change-by-statistical-area-2/
```

Used for:

- meshblock population weighting
...
- bicycle commute modelling
- time-dependent routing
- congestion modelling
- GPU-accelerated routing
- probabilistic commuter forecasting
- nationwide mobility simulation
